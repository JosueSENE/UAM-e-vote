...
public class EnseignantFiliereDAO {
    ...
    public void addEnseignantFilieres ( Enseignant_filieres ef) throws SQLException{
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            else System.err.println("Succés : Enseignant "+ef.getEnseignant_id()+" ajouté dans la filière "+ef.getFiliere_id());
    ...
    public List<Enseignant_filieres> getAllEnseignantFilieres() throws SQLException{
    ...
    public void updateEnseignantFiliere (Enseignant_filieres ef, int anciennefiliereid) throws SQLException{
