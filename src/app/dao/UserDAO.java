...
public class UserDAO {
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            try (ResultSet rs = ps.executeQuery()) {
                if (rs.next()) {
                    ...
                    u.setFiliere_id(rs.getObject("filiere_id") != null ? rs.getInt("filiere_id") : null);
    ...
    public boolean addUser(User u) {
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            if (u.getFiliere_id() > 0) { ps.setInt(6, u.getFiliere_id()); } 
    ...
    public List<User> getAllUsers() {
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            while (rs.next()) {
                ...
                // Gestion sécurisée des NULLs provenant de la base
                u.setFiliere_id(rs.getObject("filiere_id") != null ? rs.getInt("filiere_id") : null);
                u.setNiveau(rs.getString("niveau"));
                liste.add(u);
            } 
