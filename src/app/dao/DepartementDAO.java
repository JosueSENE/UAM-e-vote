...
public class DepartementDAO {
    ...
    public Departement searchDepartementBtId(int id) {
    ...
    public Departement searchDepartementBtName(String nom) {
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            System.err.println("❌ Erreur lors de la recherche du département " + nom);
            e.printStackTrace();
        }
        return null;
    }
    ...
    //===============================================
    // RECUPERER TOUS LES DÉPARTEMENTS D'UNE UFR
    //===============================================

    public List<Departement> getDepartementsForUfr(int idUfr) {
        List<Departement> liste = new ArrayList<>();
        String sql = "SELECT d.*, u.nom AS ufr_nom " +
                    "FROM departements d " +
                    "LEFT JOIN ufr u ON d.ufr_id = u.id " +
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            System.err.println("❌ Erreur lors de la récupération des départements de l'ufr ayant comme id :"+idUfr);
            e.printStackTrace();
        }
        return liste;
    }
